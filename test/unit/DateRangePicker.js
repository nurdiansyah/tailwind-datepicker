...
describe("DateRangePicker", function () {
  ...
  describe("constructor", function () {
    ...
    it("does not add the active class to the picker elements", function () {
      ...
      expect(
        dpElems.filter((el) => el.classList.contains("active")),
        "to be empty"
      );
    });
